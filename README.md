...
- Unit tests, no UI tests: The project description said UI tests were optional, so I put my testing time into the networking, cache, and view model layers where bugs would hurt most.
  
Weakest Part of the Project: What do you think is the weakest part of your project?

The weakest part is the visual finish. I used SwiftUI’s out of the box styles and didn’t use custom colors, typography, or subtle animations. The screens do everything they’re supposed to, but they look plain and default. 
